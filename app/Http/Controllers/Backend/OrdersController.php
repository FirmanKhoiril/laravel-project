...
class OrdersController extends Controller 
{
    public function getIndex(Request $request)
    {
        ...
        ->join('customers', 'customers_id', '=', 'tr_orders.customers_id')
    ...
    public function getDetail($id)
    {
        ...
        ->join('customers', 'customers_id', '=', 'tr_orders_detail.customers_id')
        ->where('tr_orders.id', $id)
        ->select('tr_orders.*', 'customers.name as customer_name')
        ->first();
        $data['detail'] = DB::table('tr_orders_detail')
        ->where('tr_orders_id', $id)
        ->join('produts', 'products.id', '=', 'tr_orders_detail.products.id')
